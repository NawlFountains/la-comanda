...
export const buttonVariants = {
	base: `${SHARED_BASE} rounded-sm hover:bg-neutral-700 hover:text-neutral-200 dark:hover:bg-neutral-200 dark:hover:text-neutral-700`,
	...
	toggleOn: `${SHARED_BASE} rounded-lg bg-neutral-700 dark:bg-neutral-200 text-neutral-200 dark:text-neutral-700 font-mono border border-neutral-400 dark:border-neutral-600`,
